...
\]
By \cn, $g_{\omega}(z)$ is the uniform limit of the off-diagonal Pad\'e approximants $R_M(z)$. The rate of convergence in this case can be controlled further by \cn. 
