...
By way of the relation (\ref{eq:GRTPythag}) we can prove an analogous slice theorem for the GRT.\@
...
\begin{remark}
  It seems that the slice theorem is analogous to, perhaps generalized by the change of variables formula for the pushforward measure $R^\omega_\mu$:
  \[
