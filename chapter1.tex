...
\begin{myexample}
  Let $f:\RR^n \rightarrow \RR$ be the constant function $f(x)=1$. The Gaussian moments of $f$ are the multivariate moments of $w_n(x)$, and can be written
  \begin{align*}
    c^G_\alpha 
  ...
  \end{align*}
  where $\{c^G_k\}_{k \in \NN}$ are the univariate moments of $w(p)$.
