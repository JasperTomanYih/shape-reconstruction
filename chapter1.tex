...
\]
Notably, the exponential decay of $\gamma_n(x)$ at infinity means that the Gaussian density dominates polynomial growth in the sense that $P(x)\gamma_n(x) \to 0$ as $\norm{x} \to \infty$, even
\[
...
\begin{corollary}
  For any non-negative function $f \in L^2(\RR, \gamma)$ the moment problem given by
  \[
