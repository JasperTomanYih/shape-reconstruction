...
\begin{itemize}
  \item For $1 < p < \infty$, $L^p = L^p(\RR^n)$ is the space of Lebesgue measurable functions $f : \RR^n \to \RR$ satisfying
  \[
...
%   \item \bf{Spaces}
%   \begin{itemize}
%     \item $\NN_0 = \{0, 1, 2, \ldots \}$ the nonnegative integers. 
%     \item $S^{n-1} = \{x \in \RR^n: \|x\| = 1\}$ the unit sphere in $\RR^n$
%   \end{itemize}
%   \item \bf{Euclidean spaces}
%   \begin{itemize}
%     \item $\RR^{\NN_0}$ the sequence space $\{{(x_i)}_{i \in \NN_0}\}$
%     \item $\|x\|$ the $\ell^2$ norm on $\RR^{\NN_0}$
%     \item $\langle x, y\rangle$ the $\ell^2$ inner product on $\RR^{\NN_0}$
%   \end{itemize}
%   \item \bf{Measures}
%   \begin{itemize}
%     \item $dx$ the \textit{Euclidean measure} on $\RR^n$
%     \item $d\gamma^n$ the \textit{standard Gaussian measure} on $\RR^n$
%   \end{itemize}
%   \item \bf{Moments}
%   \begin{itemize}
%     \item ${(c_k)}_{k \in \NN_0}$ a sequence of \textit{moments}.
%     \item ${(c_\alpha)}_{\alpha \in \NN_0^n}$ a multiindexed sequence of \textit{multivariate moments}.
%     \item ${(c^G_k)}_{k \in \NN_0}$ a sequence of \textit{Gaussian moments}.
%     \item ${(c^G_\alpha)}_{\alpha \in \NN^0}$ a multiindexed sequence of \textit{multivariate Gaussian moments}
%   \end{itemize}
%   \item \bf{Transforms}
%   \begin{itemize}
%     \item $R_f$ the \textit{Radon transform} of a function $f: \RR^n \rightarrow \RR$
%     \item $GR_f$ the \textit{Gaussian Radon transform} of a function $f: \RR^n \rightarrow \RR$
%   \end{itemize}
