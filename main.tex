...
Let $g(z) = \int (1+zp)^{-1}d\mu$, where $\mu$ is a Borel measure with infinite support. When $\mu$ has bounded (unbounded resp.) support we call $g(z)$ the Markov (Hamburger resp.) transform of the measure $\mu$. 
