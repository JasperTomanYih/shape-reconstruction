...
We argue that Beylkin's framework does not lend itself to the GRT setting because it lacks a distinguished origin point. Abouelaz et al.'s transform is a promising starting point for a DGRT worth investigating further. For now, we a new DGRT following a somewhat roundabout path via the formulas of chapter 4.
